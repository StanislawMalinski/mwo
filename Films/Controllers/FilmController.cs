...
namespace Films.Controllers
{
    ...
    public class FilmController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<FilmModel>> GetFilmsByPage(int page)
        {
        ...
        public ActionResult<IEnumerable<FilmModel>> GetFilmsByFilter([FromQuery] FilterRequest filter)
        {
